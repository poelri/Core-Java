...
*  2) 메소드는 클래스안에서 객체의 행위를 정의하지만, Expression이라고 쓴 이유는 Method의 역할과 동일하지만 특정 클래스 소속이 아니기 때문이다
*  3) Lambda Expression을 사용하면서 매개변수와 리턴 타입만으로 간단히 코드를 작성 할 수 있기 때문에, 병렬 프로그래밍을 하지 않아도 되어
*    Collection Framework에서 효과적인 코드를 작성 할 수 있다.
*  4) 순서
*       - 객체의 생성부분을 삭제한다.
