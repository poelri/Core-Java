...
/*
* Stream API
* 1. Stream? : 배열이나 Collection과 같이 여러개의 데이터를 일관되게 처리하기 위해서 추가된 문법
...
* 5. 중간 연산의 결과가 Stream으로 리턴이 되기 때문에, Stream 연산을 계속 이어서 chain형태로 이용 할 수 있다.
* 6. But, 최종연산의 결과는 Stream이 아니기 때문에 일단 최종연산을 수행하면 다시 다른 Stream 연산을 수행 할 수 없다.
* 7. Stream 연산은 원본의 데이터를 읽어서 기능을 수행하지만, 그 내용을 변경하지는 않는다
* */
public class StreamDemo {
    public static void main(String[] args) {
        // Stream 생성 : 배열을 이용할 것인가, 아니면 Collectrion을 이용 할것인가에 따라 다르다
        // 배열로부터 Stream 생성하기
        Integer [] intArray = {12,3,4,5};
